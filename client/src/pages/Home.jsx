  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative bg-black text-white rounded-3xl overflow-hidden mb-12 shadow-2xl">
        <div className="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-1788849538812-7d6f6188dce0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHx0b3BpYy1mZWVkfDk1fGJvOGpRS1RhRTBZfHxlbnwwfHx8fHw%3D')] bg-cover bg-center"></div>
        ...
        <div className="relative p-10 md:p-20 text-center flex flex-col items-center z-10">
          <span className="bg-white/20 text-white backdrop-blur-md px-4 py-1.5 rounded-full text-xs font-bold tracking-widest uppercase mb-6 border border-white/20">
            Welcome to BookMyEvent - Your Gateway to Unforgettable Experiences
          </span>
